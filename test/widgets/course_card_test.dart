...
void main() {
  group('CourseCardWidget Tests', () {
    ...
    testWidgets('should display default graduation cap icon when no icon provided', (tester) async {
      // Arrange
    ...
    testWidgets('should display "view details" button', (tester) async {
      ...
      // Assert
      expect(find.text('ເບິ່ງລາຍລະອຽດ'), findsOneWidget); // "View details" in Lao
      expect(find.byIcon(Icons.arrow_forward_rounded), findsOneWidget);
    });

    testWidgets('should handle long course titles with ellipsis', (tester) async {
      // Arrange
      final course = createTestCourse(
        title: 'This is a very long course title that should be truncated with an ellipsis when displayed',
      );
    ...
    testWidgets('should render button with gradient background', (tester) async {
      // Arrange
      final course = createTestCourse();
