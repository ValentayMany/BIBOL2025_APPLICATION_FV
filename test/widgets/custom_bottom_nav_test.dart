  ...
  group('CustomBottomNav Tests', () {
    ...
    testWidgets('should display all 5 navigation items', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(CustomBottomNav(currentIndex: 0, onTap: (_) {})),
      );
    ...
    testWidgets('should display correct icons for each nav item', (
      tester,
    ) async {
      // Arrange & Act
      await tester.pumpWidget(
    ...
    testWidgets('should highlight selected item (index 1)', (tester) async {
      // Arrange & Act
      await tester.pumpWidget(
        makeTestableWidget(CustomBottomNav(currentIndex: 1, onTap: (_) {})),
      );
    ...
    testWidgets('should highlight selected item (index 2)', (tester) async {
      // Arrange & Act
      await tester.pumpWidget(
        makeTestableWidget(CustomBottomNav(currentIndex: 2, onTap: (_) {})),
      );
    ...
    testWidgets('should highlight selected item (index 3)', (tester) async {
      // Arrange & Act
      await tester.pumpWidget(
        makeTestableWidget(CustomBottomNav(currentIndex: 3, onTap: (_) {})),
      );
    ...
    testWidgets('should highlight selected item (index 4)', (tester) async {
      // Arrange & Act
      await tester.pumpWidget(
        makeTestableWidget(CustomBottomNav(currentIndex: 4, onTap: (_) {})),
      );
    ...
    testWidgets('should call onTap with correct index when home is tapped', (
      tester,
    ) async {
      // Arrange
      int? tappedIndex;
    ...
    testWidgets('should call onTap with correct index when news is tapped', (
      tester,
    ) async {
      // Arrange
      int? tappedIndex;
    ...
    testWidgets('should call onTap with correct index when gallery is tapped', (
      tester,
    ) async {
      // Arrange
      int? tappedIndex;
    ...
    testWidgets('should call onTap with correct index when about is tapped', (
      tester,
    ) async {
      // Arrange
      int? tappedIndex;
    ...
    testWidgets('should call onTap with correct index when profile is tapped', (
      tester,
    ) async {
      // Arrange
      int? tappedIndex;
    ...
    testWidgets('should show active indicator for selected item', (
      tester,
    ) async {
      // Arrange & Act
      await tester.pumpWidget(
    ...
    testWidgets('should have animation controller', (tester) async {
      ...
      // Assert
      final state = tester.state<State>(find.byType(CustomBottomNav));

      expect(state, isA<SingleTickerProviderStateMixin>());
    });

    testWidgets('should update animation when currentIndex changes', (
      tester,
    ) async {
      // Arrange
      int currentIndex = 0;
