...
class AnalyticsService {
  ...
  static void logLogin(String userId, {String method = 'email'}) {
    logEvent('login', {'user_id': userId, 'method': method});
  }
  ...
  /// - [itemId] - ID ของรายการ
  /// - [itemName] - ชื่อรายการ
  static void logItemView(String itemType, String itemId, String itemName) {
    logEvent('item_view', {
      'item_type': itemType,
      'item_id': itemId,
      'item_name': itemName,
  ...
  /// - [method] - วิธีการแชร์
  static void logShare(String contentType, String contentId, String method) {
    logEvent('share', {
