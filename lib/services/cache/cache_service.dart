...
class CacheService {
  ...
  /// Cache courses list
  static Future<void> cacheCourses(List<Map<String, dynamic>> coursesList) async {
    try {
      await _ensureInitialized();
  ...
  /// Cache gallery items
  static Future<void> cacheGallery(List<Map<String, dynamic>> galleryList) async {
    try {
      await _ensureInitialized();
      ...
      AppLogger.debug('Cached ${galleryList.length} gallery items', tag: 'CACHE');
    } catch (e) {
